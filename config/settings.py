...
# Load environment variables from the .env file in the BASE_DIR or bodrless-be directory
BASE_DIR = Path(__file__).resolve().parent.parent
dotenv_path = os.path.join(BASE_DIR, '.env')
if not os.path.exists(dotenv_path):
    # Try bodrless-be directory if not found in BASE_DIR
...
# IntaSend Payment Gateway Settings
...
# If IntaSend is not properly configured, disable it
